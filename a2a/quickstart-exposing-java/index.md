...
- [**A2A Quickstart (Consuming) for Java**](https://google.github.io/adk-docs/a2a/quickstart-consuming-java/index.md): Learn how your agent orchestrator wrapper connects downstream to exposed services.
